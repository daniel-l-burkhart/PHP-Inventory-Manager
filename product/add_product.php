...
if (isset($_POST['add_product'])) {
    ...
    if (empty($errors)) {
        ...
        $p_category = make_HTML_compliant($db->get_escape_string($_POST['product-category']));
        ...
        $query = "INSERT INTO products (name, quantity, cost_price, sale_price, category_id, date) VALUES ('{$p_name}', '{$p_quantity}', '{$p_vendor_cost}', '{$p_selling_price}', '{$p_category}', NOW()) ON DUPLICATE KEY UPDATE name='{$p_name}'";
