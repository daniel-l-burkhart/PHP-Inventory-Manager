...
<?php
  ...
  if(isset($_POST['update'])) {
    ...
    if(empty($errors)){
             $id = (int)$e_user['id'];
           $name = make_HTML_compliant($db->escape($_POST['name']));
       $username = make_HTML_compliant($db->escape($_POST['username']));
          $level = (int)$db->escape($_POST['level']);
       $status   = make_HTML_compliant($db->escape($_POST['status']));
       ...
       <div class="panel-body">
          <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            <div class="form-group">
                  ...
                  <input type="name" class="form-control" name="name" value="<?php echo make_HTML_compliant(ucwords($e_user['name'])); ?>">
            </div>
            <div class="form-group">
                  <label for="username" class="control-label">Username</label>
                  <input type="text" class="form-control" name="username" value="<?php echo make_HTML_compliant(ucwords($e_user['username'])); ?>">
            </div>
            <div class="form-group">
